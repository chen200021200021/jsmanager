...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	<div class="form-group">
    	<label for="fTable" class="col-xs-3 col-sm-3 col-md-3 control-label">所带班级</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
       		<select class="form-control cmm_category" type="class" name="classid" disabled>
			</select>
    	</div>
  	</div>
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>工号</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
  	...
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>身份证号</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
