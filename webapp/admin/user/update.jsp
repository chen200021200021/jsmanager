...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	...
	<div class="form-group  mt-10">
  	...
  	<div class="form-group">
    	...
    	<div class="col-xs-6 col-sm-6 col-md-6">
       		<select class="form-control cmm_code" code="USER_TYPE" name="utype">
			</select>
    	</div>
  	</div>
  	<div class="form-group">
    	<label for="fTable" class="col-xs-3 col-sm-3 col-md-3 control-label"><span style="color:#F00">*</span>状态</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
       		<select class="form-control cmm_code" code="USER_STATUS" name="status">
			</select>
    	</div>
  	</div>
  	<div class="form-group">
...
$(function(){
    ...
    $("#formId1").validate({
		rules:{
			...
			status:{required:true,minlength:1,maxlength:20},
		},
		onkeyup:false,
		focusCleanup:true,
